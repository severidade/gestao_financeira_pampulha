    ...
    <html>
      <head>
        ...
        <style>
          ...
          // body { font-family: 'Barlow', sans-serif; padding: 0; margin: 0; background-color: tomato; }
        ...
        <div id="tela-relatorio" class="container">
          <div class="card">
            ...
            <div class="no-print" style="margin-top: 25px; border-top: 1px solid #eee; padding-top: 15px;">
              <a href="https://forms.gle/8xTp4VAx4UN79Fe36" target="_blank" style="text-decoration:none;">
